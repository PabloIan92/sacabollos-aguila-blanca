...
export type Kind = 'waiting' | 'active' | 'parts' | 'done' | 'blocked' | 'cancelled'
...
export const KIND_CLASSNAME: Record<Kind, string> = {
  waiting: 'bg-gray',
  active: 'bg-blue',
  parts: 'bg-brass',
  done: 'bg-green',
...
export function etiquetaEtapa(idx: number): string {
